...
> [!Warning]
> This file is a dump of ideas. 
> It contains widely speculative thoughts, many generated by AI Agents that may not reflect the vision of the Humans in the team. 
> Not everything in this file was reviewed by Humans. It may or not make sense. I may or not ever be implemented.
...
- (promoted) ~~Fortran interface over Rust~~ — delivered; the
  synchronous binding ships in `fortran/` (see `TODO.md`
  *Multi-Language Support* for the remaining demand-driven follow-ups).
