...
static std::string descriptor_json(const char* param) {
    ...
    std::snprintf(buf, sizeof(buf),
        R"({"version":3,"descriptors":[{"type":"ntensor","ndim":2,"shape":[181,360],"strides":[360,1],"dtype":"float32","byte_order":"little","encoding":"none","filter":"none","compression":"none"}],"base":[{"mars":{"param":"%s","step":0}}]})",
        param);
    return buf;
}
