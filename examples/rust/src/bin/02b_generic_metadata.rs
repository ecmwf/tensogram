...
//! keys.  This example attaches a made-up `"product"` namespace to a 2-D
//! field (name, units, acquisition device, ...) to show how any domain
//! can model its semantics inside `base[i]`.
//!
