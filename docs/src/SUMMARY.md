...
- [Objects and Dtypes](concepts/objects.md)
- [The Encoding Pipeline](concepts/pipeline.md)
...
- [Simple Packing](encodings/simple-packing.md)
- [Byte Shuffle Filter](encodings/shuffle.md)
- [Compression](encodings/compression.md)

---

# CLI Reference

- [tensogram info](cli/info.md)
- [tensogram ls](cli/ls.md)
- [tensogram dump](cli/dump.md)
...
- [tensogram doctor](cli/doctor.md)
